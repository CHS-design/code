...
def train_val_data_process():
    # 数据集路径
    ROOT_TRAIN_DATA = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data_me', 'train')
    ROOT_VAL_DATA = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data_me', 'test')
    ...
    # 加载训练集和验证集
    train_data = ImageFolder(ROOT_TRAIN_DATA,transform)
